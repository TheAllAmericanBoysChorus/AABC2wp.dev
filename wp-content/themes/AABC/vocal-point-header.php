      ...
      <div class="main-cta">
          <div class="row">
              <div class="small-10 small-centered columns text-center">
                  <h1><?php the_title();?></h1>
                  <h5>Come See One Of The Greatest Acapella Groups<br/> With A Special Performance By The All-American Boys Chorus</h5>
                  <a href="https://app.arts-people.com/index.php?ticketing=aabc"><button type="button" name="button" class="main-cta-btn">Buy Tickets</button></a>
              </div>
          </div>
      </div>
  </div>
